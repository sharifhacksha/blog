"""
URL configuration for blogp project.
...
from shafikstore1.views import index_view,blog_list_view,add_author_view,edit_author_view,delete_author_view,sign_up_view
